...
INSERT INTO BRANCHES (NAME, REPOSITORY_ID) VALUES
  ('branch-a', 1),
  ('branch-b', 2);

INSERT INTO BRANCH_META (BRANCH_ID)
  SELECT b.ID FROM BRANCHES b WHERE  b.NAME = 'branch-a';

INSERT INTO BRANCH_META (BRANCH_ID)
  SELECT b.ID FROM BRANCHES b WHERE  b.NAME = 'branch-b';
